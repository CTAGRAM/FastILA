    ...
    <header className="site-header">
      ...
      <div className="site-nav">
        <div className="site-nav-inner">
          <a className="brand-wordmark on-light" href="?mode=booking" onClick={(e) => { e.preventDefault(); window.location.href = "?mode=booking"; }} title="Home">
            <span className="b-fast">fast</span>
            <span className="b-ila">ila<span className="b-mark"/></span>
          </a>
          {!compact && (
            <nav className="site-nav-links">
              <a href="?mode=booking" onClick={(e) => { e.preventDefault(); window.location.href = "?mode=booking"; }}>Expertise <Icon name="chevron-down" size={14}/></a>
              <a href="?mode=booking" onClick={(e) => { e.preventDefault(); window.location.href = "?mode=booking"; }}>Client Stories</a>
              <a href="?mode=booking" onClick={(e) => { e.preventDefault(); window.location.href = "?mode=booking"; }}>About <Icon name="chevron-down" size={14}/></a>
              <a href="?mode=booking" onClick={(e) => { e.preventDefault(); window.location.href = "?mode=booking"; }}>Resources <Icon name="chevron-down" size={14}/></a>
            </nav>
          )}
  ...
  <div className="site-guarantee">
    <div className="site-guarantee-inner">
      ...
      <div className="row items-center gap-2">
        ...
        <a href="?mode=booking" onClick={(e) => { e.preventDefault(); if (window.fiToast) window.fiToast("Email a competitor quote to info@fast-ila.co.uk — we'll match it + 10%"); }}><u>We will beat it by at least 10%</u></a>
      </div>
    </div>
  </div>
);
